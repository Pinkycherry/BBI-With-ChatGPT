...
const glossary = [
  ...
  // SaaS & Subscription
  {
    ...
    definition:
      "The normalized monthly amount of subscription revenue a company expects to receive. It excludes one-time fees.",
    why_it_matters:
      "MRR is the lifeblood of a SaaS business. It provides predictability, allowing founders to forecast cash flow and invest in growth with confidence.",
    example_in_practice:
      "If a customer signs a $12,000 annual contract, it contributes $1,000 to MRR.",
  ...
  },
  {
    ...
    category: "SaaS & Subscription",
    definition:
      "The percentage of total customers who cancel their subscription over a given period.",
    why_it_matters:
      "High churn is fatal to subscription businesses. If churn outpaces acquisition, growth stalls entirely. A good logo churn rate for SMB SaaS is <3% monthly, and <10% annually for enterprise.",
    example_in_practice:
      "If you start the month with 100 customers and 5 cancel, your monthly customer churn rate is 5%.",
  ...
  },
  {
    ...
    why_it_matters:
      "Gross revenue churn shows the baseline revenue leakage before accounting for upsells. It indicates if the core product is losing value for existing users.",
    example_in_practice:
      "If you had $100k MRR, and lost $5k to cancellations and $2k to downgrades, your gross revenue churn is 7%.",
  ...
  },
  {
    ...
    category: "SaaS & Subscription",
    definition:
      "The percentage of recurring revenue retained from existing customers over a period, factoring in downgrades, cancellations, and expansion (upsells/cross-sells).",
    why_it_matters:
      "NRR > 100% means the business can grow revenue even if it acquires zero new customers. Top-tier public SaaS companies often have NRR between 110% and 130%.",
    example_in_practice:
      "Starting MRR: $100k. Lost MRR: $5k. Downgraded: $2k. Expansion (Upsell): $15k. Ending MRR from that cohort: $108k. NRR is 108%.",
  ...
  },
  {
    ...
    category: "SaaS & Subscription",
    definition:
      "Additional recurring revenue generated from existing customers through upselling (higher tiers), cross-selling (new products), or seat expansions.",
    why_it_matters:
      "Expansion revenue is much cheaper to acquire than new logo revenue (CAC is near zero). It is the primary driver of Net Revenue Retention > 100%.",
    example_in_practice:
      "A customer paying $100/mo for 10 seats upgrades to 15 seats, paying $150/mo. The $50 difference is expansion revenue.",
  ...
  },
  {
    ...
    category: "SaaS & Subscription",
    definition:
      "The actual invoice amounts billed to customers in a period. This includes recognized recurring revenue plus changes in deferred revenue.",
    why_it_matters:
      "While MRR measures revenue linearly over time, billings measures actual cash movement. High billings (like upfront annual payments) improve cash flow drastically.",
    example_in_practice:
      "A customer signs a $12,000 annual contract and pays upfront on Day 1. The MRR is $1,000, but the Billings for that month is $12,000.",
  ...
  },
  {
    ...
    category: "SaaS & Subscription",
    definition:
      "Money received from customers for services that have not yet been delivered or recognized as revenue.",
    why_it_matters:
      "Deferred revenue is a liability on the balance sheet but represents positive cash flow. It's the hallmark of a healthy SaaS business with annual upfront payments.",
    example_in_practice:
      "Receiving $12,000 upfront for an annual software subscription creates $12,000 in deferred revenue, which converts to recognized revenue at $1,000 per month.",
  ...
  },
  {
    ...
    category: "SaaS & Subscription",
    definition:
      "The total value of all signed contracts in a given period, regardless of when the cash is collected or revenue is recognized.",
    why_it_matters:
      "Bookings are the ultimate leading indicator of future revenue growth. It measures the pure success of the sales team.",
    example_in_practice:
      "If a sales rep signs a 3-year deal worth $30,000 total, the Bookings amount for that month is $30,000.",
...
const expandedTopics = [
  ...
  [
    ...
    "The dominant business model of the 21st century due to recurring revenue and scalable cloud delivery.",
  ...
  [
    ...
    "Abstracts away server management so developers can focus on writing code.",
    "Heroku or Vercel.",
    "",
  ],
  [
    ...
    "The foundational layer of the cloud.",
  ...
  [
    ...
    "Magic Number = (Current Q ARR - Previous Q ARR) / Previous Q S&M Spend",
  ],
];

const finalGlossary = [...baseData];
