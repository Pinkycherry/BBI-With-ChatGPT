...
console.log("Calc duplicates:", calcSlugs.filter((s, i, a) => a.indexOf(s) !== i));
console.log("Case duplicates:", caseSlugs.filter((s, i, a) => a.indexOf(s) !== i));
console.log("Guide duplicates:", guideSlugs.filter((s, i, a) => a.indexOf(s) !== i));
console.log("Gloss duplicates:", glossSlugs.filter((s, i, a) => a.indexOf(s) !== i));
