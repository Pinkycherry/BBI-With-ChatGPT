...
export const STARTUP_GUIDES: StartupGuideMeta[] = [
  ...
  },
  {
    ...
    description: "The graveyard of startups isn't littered with bad ideas, but with unvalidated ones. Founders, blinded by conviction, often build elaborate solutions t...",
    category: "Validation",
    wordCount: 1056,
    readTime: "5 min read",
    publishedDate: "2026-09-14",
  ...
  },
  {
    ...
    description: "Understanding your market isn't a theoretical exercise; it’s a foundational requirement for any operator building a viable business. Too many founders...",
    category: "Market Sizing",
    wordCount: 1109,
    readTime: "5 min read",
    publishedDate: "2026-09-14",
