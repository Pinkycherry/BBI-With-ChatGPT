...
import { useElementPointerGroup, useMagnet } from "@/motion";
...
function PlatformButton({
  ...
  return (
    <button
      ...
      className="mo-card cinematic-validate-platform inline-flex items-center gap-2.5 rounded-md px-6 py-3 text-sm font-semibold disabled:cursor-wait disabled:opacity-70"
    >
...
export function ValidateButton({ 
  ...
  const primaryRef = useMagnet<HTMLButtonElement>({ max: 4, strength: 0.2 });
  const platformsRef = useElementPointerGroup<HTMLDivElement>(".cinematic-validate-platform");
  ...
  return (
    <section className="cinematic-validate-console mt-10 rounded-3xl px-5 py-7 sm:px-8">
      ...
      <div ref={platformsRef} className="cinematic-validate-platforms mt-6 flex flex-wrap gap-3">
