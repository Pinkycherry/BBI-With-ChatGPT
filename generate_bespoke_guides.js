...
const guidesMetadata = [
  ...
  },
  {
    ...
    category: "Launch & Ops",
    intro:
      "A botched launch doesn't just burn your initial traffic spike; it destroys early credibility. Too many startups push to production without a rigorous pre-launch checklist, resulting in broken payment gateways, routing errors, and uncaptured leads. Operations dictate outcomes.",
  },
  {
  ...
  },
  {
    ...
    intro:
      "Investors do not care about top-down market sizing that claims you will capture '1% of a trillion-dollar industry.' Market sizing must be a bottom-up calculation based on actual customer units, specific segments, and realistic sales capacity. Your TAM, SAM, and SOM define your strategic ceiling.",
  },
  {
...
function generateMarkdown(guide) {
  ...
  content.push(
    `When optimizing this process, **${guide.supporting[0]}** plays a critical role in establishing a baseline. Without it, you are flying blind.`,
  );
  ...
  content.push(
    `Integrating ${guide.supporting[1]} allows your team to move faster while maintaining structural integrity.`,
  );
  ...
  content.push(
    `To truly scale, you must prioritize **${guide.supporting[2]}**. This is the operational lever that dictates long-term viability.`,
  );
  ...
  content.push(
    `2. **Implement Tactical Fixes**: Apply the operator framework to your ${guide.supporting[0]} immediately.`,
  );
  content.push(
  ...
  content.push(
    `Success in this arena is not about finding a silver bullet. It is about relentlessly applying the principles of ${guide.focus} day in and day out. Build the systems, trust the data, and execute with precision.`,
  );
